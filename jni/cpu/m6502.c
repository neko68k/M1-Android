...
int m6502_ICount = 0, m6502_fullCount;
...
int m6502_getcycles(void)
{
	return (m6502_fullCount - m6502_ICount);
}

void m6502_yield(void)
{
	m6502_fullCount = m6502_getcycles();
...
{
    	m6502_fullCount = cycles;	// keep how many we're supposed to run
	m6502_ICount = cycles;
