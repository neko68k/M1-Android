...
int 	h6280_ICount = 0, h6280_fullCount;
...
int h6280_getcycles(void)
{
	return (h6280_fullCount - h6280_ICount);
}

void h6280_yield(void)
{
	h6280_fullCount = h6280_getcycles();
