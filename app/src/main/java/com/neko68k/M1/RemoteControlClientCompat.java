...
public class RemoteControlClientCompat {
    ...
    public static int FLAG_KEY_MEDIA_PAUSE = 8;
    public static int FLAG_KEY_MEDIA_NEXT = 80;
    ...
    public class MetadataEditorCompat {
        ...
        public final static int METADATA_KEY_ARTIST = 2;
        public final static int METADATA_KEY_ALBUM = 1;
        public final static int METADATA_KEY_TITLE = 7;
        public final static int METADATA_KEY_DURATION = 9;
