...
#ifdef activecpu_get_pc
#undef activecpu_get_pc
#endif

#define activecpu_get_pc() h6280.pc
 ...
 ***************************************************************/
#define RDMEM(addr) 											\
	h6280_read( (h6280.mmr[(addr)>>13] << 13) | ((addr)&0x1fff))

/***************************************************************
 *  WRMEM   write memory
 ***************************************************************/
#define WRMEM(addr,data)										\
	h6280_write( (h6280.mmr[(addr)>>13] << 13) | ((addr)&0x1fff),data);
...
#define RDMEMW(addr)											\
	h6280_read( (h6280.mmr[(addr)  >>13] << 13) | ((addr  )&0x1fff)) \
| ( h6280_read( (h6280.mmr[(addr+1)>>13] << 13) | ((addr+1)&0x1fff)) << 8 )
 ...
 ***************************************************************/
#define RDOP()													\
	h6280_read((h6280.mmr[PCW>>13] << 13) | (PCW&0x1fff))
 ...
 ***************************************************************/
#define ST0                                                     \
    h6280_writeport(0x0000,tmp)

/* 6280 ********************************************************
 *  ST1 Store at hardware address 2
 ***************************************************************/
#define ST1                                                     \
    h6280_writeport(0x0002,tmp)

/* 6280 ********************************************************
 *  ST2 Store at hardware address 3
 ***************************************************************/
#define ST2                                                     \
    h6280_writeport(0x0003,tmp)
