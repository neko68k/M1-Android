...
static I8039_Regs R;
int	   i8039_ICount, i8039_fullCount;
static UINT8 Old_T1;
...
int i8039_getcycles(void)
{
	return (i8039_fullCount - i8039_ICount);
}

void i8039_yield(void)
{
	i8039_fullCount = i8039_getcycles();
...
int n7751_getcycles(void) { return i8039_getcycles(); }
void n7751_yield(void) { i8039_yield(); }
...
unsigned n7751_dasm(char *buffer, unsigned pc)
{
	...
	return Dasm8039(buffer,pc);
#else
	sprintf( buffer, "$%02X", I8039_RDMEM(pc) );
	return 1;
#endif
}
#endif
