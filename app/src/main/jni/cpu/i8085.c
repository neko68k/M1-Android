 ...
 * Cycles
 ****************************************************************************/
int i8085_getcycles(void)
{
	return (i8085_fullCount - i8085_ICount);
}

void i8085_yield(void)
{
	i8085_fullCount = i8085_getcycles();
