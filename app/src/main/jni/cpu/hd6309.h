...
/* PUBLIC FUNCTIONS */
extern int hd6309_getcycles(void);
extern void hd6309_yield(void);
...
#define HD6309_RDMEM(Addr) ((unsigned)memory_read8(Addr))

/****************************************************************************/
/* Write a byte to given memory location									*/
/****************************************************************************/
#define HD6309_WRMEM(Addr,Value) (memory_write8(Addr,Value))
...
/****************************************************************************/
#define HD6309_RDOP(Addr) ((unsigned)memory_readop8(Addr))
...
/****************************************************************************/
#define HD6309_RDOP_ARG(Addr) ((unsigned)memory_read8(Addr))
