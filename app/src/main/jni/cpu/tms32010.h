...
#define TMS32010_BIO_In (tms32010_readport(TMS32010_BIO))
...
#define TMS32010_In(Port) (tms32010_readport((Port)<<1))
...
#define TMS32010_Out(Port,Value) (tms32010_writeport((Port)<<1,Value))
...
#define TMS32010_ROM_RDMEM(A) (tms32010_read16(((A)<<1)+TMS32010_PGM_OFFSET))
...
#define TMS32010_ROM_WRMEM(A,V) (tms32010_write16(((A)<<1)+TMS32010_PGM_OFFSET,V))
...
#define TMS32010_RAM_RDMEM(A) (tms32010_read16(((A)<<1)+TMS32010_DATA_OFFSET))
...
#define TMS32010_RAM_WRMEM(A,V) (tms32010_write16(((A)<<1)+TMS32010_DATA_OFFSET,V))
...
#define TMS32010_RDOP(A) (tms32010_read16(((A)<<1)+TMS32010_PGM_OFFSET))
...
#define TMS32010_RDOP_ARG(A) (tms32010_read16(((A)<<1)+TMS32010_PGM_OFFSET))
