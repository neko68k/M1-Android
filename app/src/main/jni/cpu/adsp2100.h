...
/****************************************************************************/
#define ADSP2100_RDMEM(A) ((unsigned)adsp_read8(A))
#define ADSP2100_RDMEM_WORD(A) ((unsigned)adsp_read16(A))

/****************************************************************************/
/* Write a byte to given memory location                                    */
/****************************************************************************/
#define ADSP2100_WRMEM(A,V) (adsp_write8(A,V))
#define ADSP2100_WRMEM_WORD(A,V) (adsp_write16(A,V))
