...
{
    m6809_fullCount = cycles;	// keep how many we're supposed to run
...
int m6809_getcycles(void)
{
	return (m6809_fullCount - m6809_ICount);
}

void m6809_yield(void)
{
	m6809_fullCount = m6809_getcycles();
