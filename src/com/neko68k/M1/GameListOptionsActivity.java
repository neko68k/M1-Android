...
public class GameListOptionsActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	View view = inflater.inflate(R.layout.gamelistsortoptions, container, false);
    	...
    	SimpleCursorAdapter sca = new SimpleCursorAdapter(this.getActivity(), android.R.layout.simple_spinner_item, cpuCursor, new String[]{"cpu"}, new int[]{android.R.id.text1},0);
    	cpulist.setAdapter(sca);
    	
    	Cursor sound1Cursor = GameListOpenHelper.getAllSound1(db);
    	sca = new SimpleCursorAdapter(this.getActivity(), android.R.layout.simple_spinner_item, sound1Cursor, new String[]{"sound1"}, new int[]{android.R.id.text1},0);
    	sound1list.setAdapter(sca);

    	Cursor sound2Cursor = GameListOpenHelper.getAllSound2(db);
    	sca = new SimpleCursorAdapter(this.getActivity(), android.R.layout.simple_spinner_item, sound2Cursor, new String[]{"sound2"}, new int[]{android.R.id.text1},0);
    	sound2list.setAdapter(sca);

    	Cursor sound3Cursor = GameListOpenHelper.getAllSound3(db);
    	sca = new SimpleCursorAdapter(this.getActivity(), android.R.layout.simple_spinner_item, sound3Cursor, new String[]{"sound3"}, new int[]{android.R.id.text1},0);
    	sound3list.setAdapter(sca);

    	Cursor sound4Cursor = GameListOpenHelper.getAllSound4(db);
    	sca = new SimpleCursorAdapter(this.getActivity(), android.R.layout.simple_spinner_item, sound4Cursor, new String[]{"sound4"}, new int[]{android.R.id.text1},0);
